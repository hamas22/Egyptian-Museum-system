      ...
      <div class="row align-items-center justify-content-between d-flex">
        ...
        <nav id="nav-menu-container">
          <ul class="nav-menu">
            ...
            <li><a href="membership_admin.php">Membership</a></li>
            <li><a href="feedback.php">FEE</a></li>

            <li><a href="event.php">Events</a></li>
            <button onclick="openModal('')" class="primary-btn text-uppercase" type="submit">Add Event</button>
      ...
      <div class="row fullscreen d-flex align-items-center justify-content-center">
        <div class="banner-content col-lg-8">
          ...
          <p class="pt-20 pb-20 text-white">
            "The Egyptian Museum in Cairo is considered one of the most important and oldest museums in the world,
            housing a rare collection of archaeological treasures from ancient Egypt. This placeholder text is intended
            to demonstrate how content will appear within the design without relying on final wording. As visitors
            explore the various halls, they can immerse themselves in the world of the pharaohs and discover the
            details of ancient Egyptian civilization."
          </p>
    ...
    <div class="col-lg-4">
      <div class="single-service">
        ...
        <div class="overlay">
          <div class="text">
            <p>
              "The Egyptian Museum pulses with the spirit of history, taking us on a journey through time to uncover
              the secrets of a civilization that continues to amaze the world to this day."
    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-lg-6 quote-right">
          <p>
            "Here begins the story — within walls engraved with the secrets of time, and artifacts that carry the scent
            of the past. The Egyptian Museum is not just a place, but a journey deep into a civilization that amazed
            the world and still tells its stories in silence and beauty."
      ...
      <div class="row">
        <div class="active-exibition-carusel">
          <div class="single-exibition item">
            ...
            <a href="#">
              <h4>visit kings in the museum</h4>
            </a>
            <p>
          ...
          <div class="single-exibition item">
            ...
            <a href="#">
              <h4>portable of latest blog for the museum</h4>
            </a>
            <p>
          ...
          <div class="single-exibition item">
            ...
            <a href="#">
              <h4>Drawing the King</h4>
            </a>
            <p>
              drawing the king was not just a depiction of a ruler, but an immortalization of divine power, where every
              line captured the essence of eternity.
            </p>
          ...
          <div class="single-exibition item">
            ...
            <p>
              one of the most famous gods in ancient Egyptian mythology. He is known as the God of the Dead and
              Embalming, and he was responsible for guiding souls to the afterlife and protecting tombs.
          ...
          <div class="single-exibition item">
            ...
            <a href="#">
              <h4>Power of King Tutankhamun
              </h4>
            </a>
            <p>
              utankhamun's legacy echoes through the centuries. His reign marked a return to traditional beliefs and
              stability after a period of turmoil.
            </p>
          ...
          <div class="single-exibition item">
            ...
            <a href="#">
              <h4>The Legend of Anubis
              </h4>
            </a>
            <p>
              Anubis emerged as a mysterious and powerful deity. With the head of a jackal and the body of a man, he
              became the guardian of the dead, the protector of tombs, and the master of embalming.
          ...
          <div class="single-exibition item">
            ...
            <a href="#">
              <h4>The Builders of the Pyramids</h4>
            </a>
            <p>
              The pyramids have long stood as symbols of the grandeur of ancient Egyptian civilization. But behind
              these architectural marvels were thousands of skilled workers, artisans, and engineers who carved their
              glory into stone with tireless hands and unwavering hearts.
            </p>
      ...
      <div class="row">
        <div class="col-lg-6 event-left">
          <div class="single-events">
            ...
            <a href="event.php">
              <h4>Event on the kings place</h4>
            </a>
            <h6><span>20st Februay</span> at the Egyptian Museum</h6>
            <p>
              Step into the heart of ancient power at The Place of Kings, inside the legendary Egyptian Museum. Join us
              for an unforgettable evening where history comes alive among the shadows of mighty pharaohs.
          ...
          <div class="single-events">
            ...
            <a href="event.php">
              <h4>Event on A Day in the Life of Ancient Egyptians</h4>
            </a>
            <h6><span>21st February</span> at Central government museum</h6>
            <p>
              Discover what the pharaohs ate, how they dressed, the secrets of their homes, their farming techniques,
              the crafts they mastered, and even the games they played!
            </p>
            <a href="event.php" class="primary-btn text-uppercase">View Details</a>
          </div>
        </div>
        <div class="col-lg-6 event-right">
          <div class="single-events">
            <a href="event.php">
              <h4>Event on The Unity and Power of Civilizations</h4>
            </a>
            <h6><span>11st March</span> at Central government museum</h6>
            <p>
              The true strength of civilizations lies in their connection, not in isolation. Each civilization
              contributed a stone to the structure of humanity, and every cultural exchange sparked new waves of
              progress. When civilizations come together, identities are not erased — they blossom, reflecting the
              finest expressions of the human spirit.
            </p>
            <a href="event.php" class="primary-btn text-uppercase">View Details</a>
          ...
          <div class="single-events">
            ...
            <a href="event.php">
              <h4>Event on the Pharaonic Eras </h4>
            </a>
            <h6><span>12st May</span> at the Egyptian Museum</h6>
            <p>
              The Pharaonic era began with the unification of Upper and Lower Egypt by King Menes (Narmer) around 3100
              BCE, marking the start of a civilization that thrived for over 3,000 years.
  ...
  <section class="gallery-area section-gap" id="gallery">
    <div class="container">
      ...
      <div id="grid-container" class="row">
        ...
        <a class="single-gallery" href="../assets/img/pg10.jpeg"><img class="grid-item"
            src="../assets/img/pg10.jpeg"></a>
        <a class="single-gallery" href="../assets/img/pg11.jpeg"><img class="grid-item"
            src="../assets/img/pg11.jpeg"></a>
        <a class="single-gallery" href="../assets/img/pg12.jpeg"><img class="grid-item"
            src="../assets/img/pg12.jpeg"></a>
        <a class="single-gallery" href="../assets/img/pg13.jpeg"><img class="grid-item"
            src="../assets/img/pg13.jpeg"></a>
        <a class="single-gallery" href="../assets/img/pg14.jpeg"><img class="grid-item"
            src="../assets/img/pg4.jpeg"></a>
        <a class="single-gallery" href="../assets/img/pg15.jpeg"><img class="grid-item"
            src="../assets/img/pg15.jpeg"></a>
      </div>
    </div>
  </section>
  <!-- End gallery Area -->
